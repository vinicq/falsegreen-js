...
### Added
- Complete "Usage and configuration reference" in the README (install channels, every output format with real samples, configuration, exit codes, CI + pre-commit).
