...
export const CASES: Record<string, CaseDef> = {
  ...
  C44: { title: "numeric tautology — a bound the value can never cross (length >= 0, > -Infinity, < Infinity)", group: "effectiveness", severity: "high", defaultOn: true, judgment: "J2" },
...
export const FIX_HINTS: Record<string, string> = {
  ...
  C44: "compare against a meaningful bound, not one the value can never cross",
